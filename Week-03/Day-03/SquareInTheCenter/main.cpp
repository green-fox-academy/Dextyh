...
void function() {
    ...
    for (int i = 0; i < 50; i++) {
        ...
        SDL_SetRenderDrawColor( gRenderer, 255, rand() % 255, rand() % 255, 0xFF );

        SDL_RenderDrawLine(gRenderer, x-50, y+50, x+50, y+50);
        SDL_RenderDrawLine(gRenderer, x-50, y-50, x+50, y-50);
    ...
    for (int i = 0; i < 50; i++) {
        ...
        SDL_SetRenderDrawColor( gRenderer, rand() % 255, 255, rand() % 255, 0xFF );
    ...
    for (int i = 0; i < 50; i++) {
        ...
        SDL_SetRenderDrawColor( gRenderer, rand() % 255, 55, 255, 0xFF );
